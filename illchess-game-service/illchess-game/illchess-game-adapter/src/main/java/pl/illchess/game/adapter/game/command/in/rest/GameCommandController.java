...
public class GameCommandController implements GameCommandApi {
    ...
    @Override
    public ResponseEntity<InitializedGameResponse> initializeNewGame(InitializeNewGameRequest initializeNewGameRequest) {
        GameId newGameId = joinOrInitializeNewGameUseCase.joinOrInitializeNewGame(initializeNewGameRequest.toCmd());
        InitializedGameResponse response = new InitializedGameResponse(newGameId.uuid());
    ...
    @Override
    public ResponseEntity<BoardFenStringResponse> establishFenString(UUID gameId) {
        FenBoardString fenBoardString = establishFenStringOfBoardUseCase.establishCurrentFenBoardString(
            new EstablishFenStringOfBoardCmd(gameId)
        );
    ...
    @Override
    public ResponseEntity<Void> quitNotYetStartedGame(QuitOccupiedGameRequest request) {
