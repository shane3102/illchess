package pl.illchess.game.adapter.game.command.out.redis.mapper;
...
import pl.illchess.game.adapter.game.command.out.redis.model.GameEntity.PreMoveEntity;
