...
class CheckBoardStateUseCaseTest extends BoardSpecification {
    ...
    def "position should be correctly considered as checkmate or stalemate"() {
        ...
        then:
        loadedBoard.boardState().gameResult() == expectedStatus
        loadedBoard.boardState().gameResultCause() == expectedGameResultCause

        where:
        fenString                                                    | expectedStatus | expectedGameResultCause
