...
import static pl.illchess.game.domain.board.model.state.GameState.CHECKMATE
import static pl.illchess.game.domain.board.model.state.GameState.STALEMATE
