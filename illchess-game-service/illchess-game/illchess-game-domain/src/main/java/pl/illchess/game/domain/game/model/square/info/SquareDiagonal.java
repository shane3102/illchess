package pl.illchess.game.domain.game.model.square.info;

import pl.illchess.game.domain.game.model.square.SquaresConnectedContents;

import static pl.illchess.game.domain.game.model.square.SimpleSquare.*;
...
public enum SquareDiagonal {
    ...
    B1_H7(SquaresConnectedContents.of(B1, C2, D3, E4, F5, G6, H7)),
